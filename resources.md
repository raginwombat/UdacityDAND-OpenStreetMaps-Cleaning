...
* https://stackoverflow.com/questions/23368575/pymongo-find-and-modify
* https://api.mongodb.com/python/current/api/pymongo/collection.html?highlight=update#pymongo.collection.Collection.find_one_and_update
* http://api.mongodb.com/python/current/api/pymongo/collection.html
* https://api.mongodb.com/python/current/tutorial.html
* https://docs.python.org/2/library/pprint.html
* https://docs.python.org/2/library/collections.html#collections.defaultdict
* http://api.mongodb.com/python/current/examples/aggregation.html?highlight=length
...
* https://stackoverflow.com/questions/27126694/can-i-run-apache-mod-wsgi-and-mongodb-within-virtualenv
